      ...
      child: StudioScaffold(
        ...
        body: tracks.isEmpty
            ? _Empty(
                ...
                onRecord: Recorder.supported ? () => _record(context) : null,
              )
            : Column(
                children: [
                  ...
                  Expanded(
                    child: ReorderableListView.builder(
                      ...
                      onReorderItem: (oldIndex, newIndex) =>
                          library.reorderTracks(book.id, oldIndex, newIndex),
          ...
          child: Row(
            children: [
              ...
              Pressable(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: t.done ? Studio.amber : Studio.line,
                      width: 1.5,
                    ),
                  ),
                  child: t.done
              ...
              SizedBox(
                width: 26,
                child: Text(
                  '${t.order > 0 ? t.order : widget.index + 1}'.padLeft(2, '0'),
